...
The blend mode applied to the `color` or `gradient` background of the container. See [`ShaderMask.blend_mode`](https://flet.dev/docs/controls/shadermask/#blend_mode) for more details.
