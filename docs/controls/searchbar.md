...
Defines the highlight [color](/docs/guides/python/colors) that's typically used to indicate that the search bar is focused, hovered, or pressed. See [Radio.fill_color](radio#fill_color) for usage examples.
