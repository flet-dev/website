...
On iOS and macOS, a [`CupertinoButton`](/docs/controls/cupertinobutton) is created, which has matching functionality and presentation this button. On other platforms, a Material `TextButton` is created.
